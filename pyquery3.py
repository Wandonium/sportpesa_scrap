...
dataSet = list()
keys = ['year', 'month', 'day', 'game_date', 'team1', 'team1_score', 
'team2', 'team2_score', 'game_status']
...
if __name__ == '__main__':
    ...
    for tr in tableRows.items():
        # few <tr> contain a single <td> so we ommit them using the following condition
        ...
        if team1 != '':
            ...
            # game status should be either 'W' for won or 'L' for lost
    ...
    print("\nTotal number of games: ", len(dataSet))
    print(dataSet)